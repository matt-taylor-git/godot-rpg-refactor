...
# Structured combat dock card: [N] TITLE + meta line (no floating icons).
...
func set_icon_texture(_tex: Texture2D) -> void:
	# Icons intentionally omitted for equal weight across all four actions.
	pass
